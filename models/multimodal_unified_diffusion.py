...
class MultiModalUnifiedDiffusionModel(nn.Module):
    """
    Conditional diffusion model with a single non-causal transformer stack over
    prompt tokens plus masked target tokens.
    """
    ...
    def __init__(
        ...
        self.decoder = UnifiedDiffusionTransformer(
